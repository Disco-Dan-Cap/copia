...
- **Splash screens** — iOS doesn't auto-generate them. Provide hand-tailored splash images for the main iPhone sizes, each one showing the cornucopia composition on retro mint per the brand motif. This is a *brand moment*; don't ship a generic white screen.
