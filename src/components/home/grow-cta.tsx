...
/**
 * "Start growing to sell" — the seller on-ramp, and the demo's bridge into the
 * seller flow. One editorial mint banner near the bottom of the scroll, not an
 * interruption. Medium Leaf Wave behind the mark; Fraunces-italic emphasis
